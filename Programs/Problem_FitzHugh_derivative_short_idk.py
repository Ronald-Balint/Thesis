...
x = layers.GRU(4, activation='sigmoid', return_sequences=True)(inputs)
x = layers.GRU(4, activation='sigmoid', return_sequences=True)(x)
x = layers.GRU(4, activation='sigmoid', return_sequences=True)(x)
x = layers.GRU(4, activation='sigmoid', return_sequences=True)(x)
x = layers.GRU(4, activation='sigmoid', return_sequences=True)(x)
x = layers.GRU(4, activation='sigmoid', return_sequences=True)(x)
...
#Print Errors
print(tf.math.subtract(v_sol, v))
print(tf.math.subtract(w_sol, w))
