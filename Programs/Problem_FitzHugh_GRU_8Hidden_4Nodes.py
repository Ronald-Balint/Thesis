...
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(inputs)
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(x)
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(x)
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(x)
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(x)
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(x)
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(x)
x = layers.GRU(4, activation='tanh', return_sequences=True, use_bias=False)(x)
outputs = layers.GRU(3, activation='linear', use_bias=False)(x)
