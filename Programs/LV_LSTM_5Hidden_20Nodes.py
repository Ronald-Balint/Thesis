...
x = layers.LSTM(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(inputs)
x = layers.LSTM(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
x = layers.LSTM(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
x = layers.LSTM(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
x = layers.LSTM(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
outputs = layers.LSTM(4, activation='relu', dtype="float64", kernel_initializer=initializer, use_bias=False)(x)
