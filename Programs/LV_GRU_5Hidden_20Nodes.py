...
def my_loss_fn(y_true, y_pred):
    ...
    error = (tfmath.reduce_sum(a1)+tfmath.reduce_sum(b1))/(2*len(z1))
    return error
...
inputs = K.Input(shape=(1, 4))
x = layers.GRU(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(inputs)
x = layers.GRU(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
x = layers.GRU(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
x = layers.GRU(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
x = layers.GRU(20, activation='tanh', dtype="float64", return_sequences=True, kernel_initializer=initializer, use_bias=False)(x)
outputs = layers.GRU(4, activation='relu', dtype="float64", kernel_initializer=initializer, use_bias=False)(x)
