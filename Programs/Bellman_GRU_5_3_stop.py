...
x=GRU(3, activation='tanh', dtype="float32",return_sequences=True)(inputs)
x=GRU(3, activation='tanh', dtype="float32",return_sequences=True)(x)
x=GRU(3, activation='tanh', dtype="float32",return_sequences=True)(x)
x=GRU(3, activation='tanh', dtype="float32",return_sequences=True)(x)
x=GRU(3, activation='tanh', dtype="float32",return_sequences=True)(x)
outputs = GRU(2, activation='tanh', dtype="float32")(x)
